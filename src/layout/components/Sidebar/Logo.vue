...
const logo = ref(new URL(`../../../assets/cola.gif`, import.meta.url).href);
</script>
  ...
  <div class="w-full h-[50px] bg-gray-800 dark:bg-[var(--el-bg-color-overlay)]">
    <transition name="sidebarLogoFade">
      ...
      >
        ...
        <span v-else class="ml-3 text-white text-sm font-bold">No-Name-Pro</span>
      </router-link>
      <router-link
        v-else
        key="expand"
      ...
      >
        ...
        <span class="ml-3 text-white text-sm font-bold">No-Name-Pro</span>
      </router-link>
    </transition>
  </div>
</template>
